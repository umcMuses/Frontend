export default function BrandIdentity() {
  return (
    <section className="relative w-[1440px] h-[1592px] flex justify-center px-[264.5px] py-[160px] border-t border-white/40 backdrop-blur-[2px] inline-flex flex-col justify-start items-start">
      <div className="w-full max-w-[896px] px-6 flex flex-col justify-start items-start gap-40">
        {/* Brand Identity & 텍스트 */}
        ...
        {/* Connect */}
        <div className="self-stretch inline-flex justify-start items-center ml-16">
        ...
        {/* Support */}
        <div className="self-stretch pl-96 pt-8 inline-flex justify-start items-center">
          <div className="inline-flex flex-col justify-start items-start gap-2.5">
        ...
        {/* Realize */}
        <div className="self-stretch pt-8 inline-flex justify-start items-center ml-16">
          <div className="inline-flex flex-col justify-start items-start gap-2.5">
