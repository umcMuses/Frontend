...
export default function PlatformFeatures() {
  return (
    <section className="w-[1440px] px-[72.5px] py-40 bg-color-white--50%/50 inline-flex flex-col justify-start items-start">
      <div className="w-full max-w-[1280px] px-6 flex flex-col justify-start items-start gap-20">
        ...
        <div className="self-stretch inline-flex justify-center items-start gap-8">
          {/* Safe Payment */}
          <div className="w-96 h-[377px] pt-[38.79px] pb-16 flex justify-center items-center gap-10 flex-1 relative bg-white/70 rounded-[40px] shadow-[0px_8px_10px_-6px_rgba(224,231,255,0.50)] shadow-[0px_20px_25px_-5px_rgba(224,231,255,0.50)] outline outline-1 outline-offset-[-1px] outline-white backdrop-blur-md overflow-hidden">
            <div className="flex flex-col items-center gap-10">
              <img src={safepayment} className="w-[224px] h-[172px]" />
          ...
          {/* Cheering */}
          <div className="w-96 self-stretch relative bg-white/70 rounded-[40px] shadow-[0px_8px_10px_-6px_rgba(224,231,255,0.50)] shadow-[0px_20px_25px_-5px_rgba(224,231,255,0.50)] outline outline-1 outline-offset-[-1px] outline-white backdrop-blur-md overflow-hidden">
            <img
          ...
          <div className="w-96 self-stretch relative bg-white/70 rounded-[40px] shadow-[0px_8px_10px_-6px_rgba(224,231,255,0.50)] shadow-[0px_20px_25px_-5px_rgba(224,231,255,0.50)] outline outline-1 outline-offset-[-1px] outline-white backdrop-blur-md overflow-hidden">
            ...
            <div className="w-72 h-7 left-[40.84px] top-[285px] absolute justify-center text-black80 text-lg font-mainFont leading-7">
              모바일 QR 시스템 하나로 복잡한 입장 절차를 스마트하게 관리하세요.
            </div>
          </div>
        </div>
      </div>
