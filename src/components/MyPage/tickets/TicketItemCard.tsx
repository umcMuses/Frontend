...
import type { TicketItem, SelectedTicket } from '../types/ticket';
...
<button className='px-4 py-2 bg-white rounded-full transition-transform hover:scale-105 text-black text-xs font-boldFont leading-4 cursor-pointer'onClick={() => onSelect(item)}>QR 보기</button>
