...
const QrCard = ({ title, seat, onClose }: QrCardProps) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-[6px]">
      <div className="w-96 bg-white rounded-2xl overflow-hidden">
        <div className="flex items-center w-96 h-32 bg-[#ff9a00] justify-center">
          <div className="self-stretch inline-flex flex-col justify-start items-start gap-2 p-6">
            <div className="self-stretch opacity-80 flex flex-col justify-start items-center">
              <div className="text-center justify-center text-[#FFF] text-xs font-boldFont leading-4 tracking-[2.40px]">
                {seat}
              </div>
            </div>
            <div className="self-stretch flex flex-col justify-start items-center">
              <div className="text-center justify-center text-[#FFF] text-2xl font-boldFont leading-8">
                {title}
              </div>
            </div>
          </div>
        ...
        <div className="w-96 p-6 bg-[#FFF] border-t border-dashed border-[#D1D5DB] inline-flex flex-col justify-start items-start">
          <button
            onClick={onClose}
            className="self-stretch py-3.5 bg-mainBlack rounded-xl shadow-[0px_4px_6px_-4px_rgba(0,0,0,0.10)] shadow-lg inline-flex justify-center items-center overflow-hidden hover:bg-[#000] cursor-pointer"
          >
